...
class GlobalFunctionsController extends Controller
{
  ...
  public static function createPdf($view, $nombre, $apellidos, $id_contacto_completo, $module, $header,$code_qr, $user){
    ...
    if($module == "caja_chica" && $header == "header_nombre_recibo") $img_header = "header_nombre_recibo";
    ...
    if($header == "header_nombre_recibo")$img_header = "header_nombre_recibo";
    ...
    if($module == "caja_chica")$mpdf->SetHTMLHeader('<img src="'.public_path('/img/mpdf/'.$img_header.'.png').'" class="img_header" style="width:100%;" alt=""><br>');
