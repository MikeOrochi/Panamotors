...
class PDFController extends Controller{
    ...
    public function vistaPrevia($id){
        ...
        try {
            ...
            foreach ($vpme_pagares as $key => $value) {
                ...
                $usuario = (object)["usuario"=>"", "fecha"=>"", "comentarios_venta"=>""];
                ...
                $usuario->comentarios_venta = $vpme->comentarios_venta;
                /*Fin Tabla de amortizacion*/

                // return view('VPMovimientoExitoso.pdf.pdf_vpme',compact('id_contacto_completo','nombre','apellidos','tipo_cliente',
    ...
    public function contratoDirectaContado($id){
        $id = Crypt::decrypt($id);
        $meses = array("Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre");
        date_default_timezone_set('America/Mexico_City');
        $date = date_create();
    ...
    public function personasFisicas($id){
        $id = Crypt::decrypt($id);
        $vpme = vista_previa_movimiento_exitoso::where('id',$id)->get()->first();
        $informacion_cliente = vpme_informacion_clientes::where('id_vista_previa_movimiento_exitoso',$id)->get()->first();
        $id_contacto = $vpme->idcontacto;
        ...
        $view = View::make('VPMovimientoExitoso.pdf.personas_fisicas',compact('nombre','apellidos',
