...
class SolicitudTallerTrucks extends Model
{
    protected $table = 'solicitud_taller_trucks';
    ...
    protected $fillable = [
      ...
      'vin','marca','version','modelo','no_orden','avance','color','empleado','visible'
    ];
    ...
    $status, $prioridad, $usuario_creador, $fecha_creacion, $fecha_guardado){
      return SolicitudTallerTrucks::create([
    ...
    $descripcion_estetica, $descripcion_extra, $combustible, $comentarios, $fecha_ingreso, $fecha_estimada, $idempleado,
    $status, $prioridad, $usuario_creador, $fecha_creacion, $fecha_guardado,$empleado){
      return SolicitudTallerTrucks::create([
        'idinventario_trucks' => $idinventario_trucks,
        'descripcion' => $descripcion,
        'porcentaje_estetica' => $porcentaje_estetica,
