...
class estado_cuenta_requisicion extends Model
{
  protected $table = 'estado_cuenta_requisicion';
  public $timestamps = false;
  protected $primaryKey = 'idestado_cuenta_requisicion';

  protected $fillable = [
     'concepto', 'idcatalogo_provedores', 'responsable', 'idcatalogo_departamento', 'estatus', 'idfoliogo', 'apartado_usado', 'tipo_movimiento', 'efecto_movimiento', 'fecha_movimiento', 'metodo_pago', 'saldo_anterior', 'saldo', 'monto_precio', 'serie_monto', 'monto_total', 'tipo_moneda', 'tipo_cambio', 'gran_total', 'cargo', 'abono', 'emisora_institucion', 'emisora_agente', 'receptora_institucion', 'receptora_agente', 'tipo_comprobante', 'referencia', 'datos_vin', 'archivo', 'comentarios', 'idauxiliar_principales', 'comision', 'columna1', 'columna2', 'columna3', 'columna5', 'columna6', 'columna7', 'columna8', 'columna9', 'columna10', 'factura', 'datos_estatus', 'usuario', 'fecha', 'visible', 'comentarios_eliminacion', 'usuario_elimino', 'fecha_eliminacion', 'usuario_creador', 'fecha_creacion', 'fecha_guardado'
  ];
