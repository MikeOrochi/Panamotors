	...
	<div class="col-sm-3 pl-0 text-center header-logo" style="display: flex;">
		...
		<div class="mr-3" style="width: 50%; background: #333;">
			<div class="avatar text-center">
				@php
	 				use App\Http\Controllers\Caja_Chica\AdminController;
		...
		<div class="inner-sidebar mr-3">
			...
			<div class="sidebar-menu-container">
				<ul class="sidebar-menu mb-4">
					...
					<li class="parent">
						<a href="{{route('Caja_Chica.index')}}" class=""><i class="fas fa-home mr-3"></i>
            ...
            <ul class="children" id="auxiliares">
              ...
              <li class="child"><a href="{{route('Caja_Chica.auxiliares.auxiliares')}}" class="ml-4"><i class="fas fa-check-square mr-2"></i> Auxiliares</a></li>
