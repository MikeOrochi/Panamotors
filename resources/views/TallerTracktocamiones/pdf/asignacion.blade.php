...
<head>
	<meta charset="UTF-8">
	<title>PANAMOTORS | Asignación de reparación a tracktocamión</title>
	<style type="text/css">
		body{
...
<body style=" margin: 0; background-image: url({{asset('public/img/mpdf/fondo_opacity.png')}}); background-repeat: no-repeat; background-position: center;">
	<div class="container">
		...
		<table class="tablax tablaxdprincipales">
                <tr>
                    <th colspan="8">Orden de asignación de reparación de unidad</th>
                </tr>
                <tr>
                    <td colspan="4" style="text-align:center;">VIN</td>
                    <td colspan="4" style="text-align:center;">Resposable</td>
                    <td colspan="4" style="text-align:center;">Fecha de salida estimada</td>
                </tr>
                <tr>
