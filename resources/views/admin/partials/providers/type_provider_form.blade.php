<div class="col-sm-12">
  <div class="shadow panel-head-primary">
    <div class="table-responsive">
      <div class="container">
        <div class="row" style="padding:30px" id='ocultar_moneda'>
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12" style="padding:10px;">
            <h6 class="text-center mt-3 mb-3"><strong>Tipo de moneda utilizada</strong></h6>
          </div>
          <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12" style="padding:10px;">
            <label for="type_person">* Moneda</label>
            <select class="form-control" name="money" id="money" required>
          ...
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12" style="margin-left: 35%; display:none;">
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="checkbox" id="product" name="product" value="1" onclick="validarCheck()" checked>
              <label class="form-check-label" for="product">Producto</label>
            </div>
          </div>
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12" style="margin-left: 35%; display:none;">
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="checkbox" id="service" value="1" name="service" onclick="validarCheck()">
              <label class="form-check-label" for="service">Servicio</label>
            </div>
          </div>
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12" style="margin-left: 35%; display:none;">
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="checkbox" id="others" value="1" name="others" onclick="validarCheck()">
              <label class="form-check-label" for="others">Otro</label>
            </div>
          </div>
        </div>
        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12" style="padding:10px; display: none;">
