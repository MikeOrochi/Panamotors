	...
	<div class="container">
		...
		<div class="content-facturar" style="margin-bottom:25px;">
			<table class="tabla-datos-facturar" autosize="1">
				...
				<tr>
					...
					<td style="width: 207px; @if(!empty($nombre)) text-transform:capitalize;@endif"><p class="text-datos-facturar">@if(!empty($apellidos)){{$apellidos}}@else{{'N/A'}}@endif</p></td>
		...
		<table class="tabla-1">
			<tr>
				...
				<th>Saldo</th>
				@else
				<th class="cargos">Comisi&oacute;n</th>
				<th class="abonos">No. Factura</th>
				<th class="saldo">Monto</th>
				<th class="saldo">Estatus</th>
				@endif
