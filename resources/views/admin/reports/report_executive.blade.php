...
<head>
	<meta charset="UTF-8">
	<title>PANAMOTORS | Reporte Ejecutivo de Compras</title>
	<style type="text/css">
		body{
	...
	<div class="container">
		...
		<table class="tablax tablaxdprincipales">
            @foreach($tabla_unidades as $key => $value)
                <tr>
                    <th colspan="8">Unidades en {{$key}}</th>
                </tr>
                <tr>
                    <td colspan="4" style="text-align:center;">Pagadas</td>
                    <td colspan="4" style="text-align:center;">Pendientes - monto a invertir</td>
                </tr>
                <tr>
                    <td style="text-align:right;"><b>Directas:</b></td>
                    <td style="text-align:left;">{{$tabla_unidades->$key->pagadas[0]['directas']}}</td>

                    <td style="text-align:right;"><b>Monto:</b></td>
                    <td style="text-align:left;"> {{number_format($tabla_unidades->$key->pagadas[0]['monto_directas'],2)}}</td>

                    <td style="text-align:right;"><b>Directas:</b></td>
                    <td style="text-align:left;"> {{$tabla_unidades->$key->pendientes[0]['directas']}}</td>

                    <td style="text-align:right;"><b>Monto:</b></td>
                    <td style="text-align:left;"> {{number_format($tabla_unidades->$key->pendientes[0]['monto_directas'],2)}}</td>
                </tr>
                <tr>
                    <td style="text-align:right;"><b>Cuenta de deuda:</b></td>
                    <td style="text-align:left;"> {{$tabla_unidades->$key->pagadas[0]['cuenta_deuda']}}</td>

                    <td style="text-align:right;"><b>Monto:</b></td>
                    <td style="text-align:left;"> {{number_format($tabla_unidades->$key->pagadas[0]['monto_cuenta_deuda'],2)}}</td>

                    <td style="text-align:right;"><b>Cuenta de deuda:</b></td>
                    <td style="text-align:left;">  {{$tabla_unidades->$key->pendientes[0]['cuenta_deuda']}}</td>

                    <td style="text-align:right;"><b>Monto:</b></td>
                    <td style="text-align:left;"> {{number_format($tabla_unidades->$key->pendientes[0]['monto_cuenta_deuda'],2)}}</td>
                </tr>
                <tr>

                    <td style="text-align:right;"><b>Devoluci&oacute;n del VIN:</b></td>
                    <td style="text-align:left;"> {{$tabla_unidades->$key->pagadas[0]['devolucion_vin']}}</td>

                    <td style="text-align:right;"><b>Monto:</b></td>
                    <td style="text-align:left;"> {{number_format($tabla_unidades->$key->pagadas[0]['monto_devolucion_vin'],2)}}</td>

                    <td style="text-align:right;"><b>Devoluci&oacute;n del VIN:</b></td>
                    <td style="text-align:left;"> {{$tabla_unidades->$key->pendientes[0]['devolucion_vin']}}</td>

                    <td style="text-align:right;"><b>Monto:</b></td>
                    <td style="text-align:left;"> {{number_format($tabla_unidades->$key->pendientes[0]['monto_devolucion_vin'],2)}}</td>
                </tr>
                <tr>
                    <td colspan="1" style="text-align:right;"><b>Total:</b></td>
                    <td style="text-align:left;"> {{$tabla_unidades->$key->total_unidades_pagadas}}</td>

                    <td colspan="1" style="text-align:right;"><b>Total:</b></td>
                    <td style="text-align:left;"> {{number_format((float)$tabla_unidades->$key->total_monto_pagadas,2)}}</td>

                    <td colspan="1" style="text-align:right;"><b>Total:</b></td>
                    <td style="text-align:left;"> {{$tabla_unidades->$key->total_unidades_pendientes}}</td>

                    <td colspan="1" style="text-align:right;"><b>Total:</b></td>
                    <td style="text-align:left;"> {{number_format((float)$tabla_unidades->$key->total_monto_pendientes,2)}}</td>
                </tr>
                <!-- ******************SEGUNDA SECCION DE PENDIENTES***************** -->
                <tr><td colspan="8"></td></tr><tr><td colspan="8"></td></tr><tr><td colspan="8"></td></tr>
                <tr>
                    <td colspan="4" style="text-align:center;">Pendientes - monto pagado</td>
                    <td colspan="4" style="text-align:center;">Pendientes - monto por pagar</td>
                </tr>
                <tr>
                    <td style="text-align:right;" colspan="2"><b>Directas:</b></td>
                    <td style="text-align:left;" colspan="2">{{number_format($tabla_unidades->$key->total_pagado_pendientes->directas,2)}}</td>

                    <td style="text-align:right;" colspan="2"><b>Directas:</b></td>
                    <td style="text-align:left;" colspan="2"> {{number_format($tabla_unidades->$key->total_restante_pendientes->directas,2)}}</td>

                </tr>
                <tr>
                    <td style="text-align:right;" colspan="2"><b>Cuenta de deuda:</b></td>
                    <td style="text-align:left;" colspan="2"> {{number_format($tabla_unidades->$key->total_pagado_pendientes->cuenta_deuda,2)}}</td>

                    <td style="text-align:right;" colspan="2"><b>Cuenta de deuda:</b></td>
                    <td style="text-align:left;" colspan="2"> {{number_format($tabla_unidades->$key->total_restante_pendientes->cuenta_deuda,2)}}</td>
                </tr>
                <tr>

                    <td style="text-align:right;" colspan="2"><b>Devoluci&oacute;n del VIN:</b></td>
                    <td style="text-align:left;" colspan="2"> {{number_format($tabla_unidades->$key->total_pagado_pendientes->devolucion_vin,2)}}</td>

                    <td style="text-align:right;" colspan="2"><b>Devoluci&oacute;n del VIN:</b></td>
                    <td style="text-align:left;" colspan="2"> {{number_format($tabla_unidades->$key->total_restante_pendientes->devolucion_vin,2)}}</td>
                </tr>
                <tr>
                    <td style="text-align:right;" colspan="2"><b>Total:</b></td>
                    <td style="text-align:left;" colspan="2"> {{number_format((float)$tabla_unidades->$key->total_pagado_pendientes_global,2)}}</td>

                    <td style="text-align:right;" colspan="2"><b>Total:</b></td>
                    <td style="text-align:left;" colspan="2"> {{number_format((float)$tabla_unidades->$key->total_restante_pendientes_global,2)}}</td>
                </tr>
            @endforeach
		</table>
		<br>
		...
		<table class="tablax tablaxdprincipales" style="font-size:8px !important; border-spacing:0; border-collapse:collapse;">
			<tr>
				<th colspan="8"><br>Detalle Compras</th>
			</tr>
