...
@section('content')
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body" align='center'>
					...
					<a href="{{route('vouchers.viewVoucher',['type_view'=>'pdf','id'=>Crypt::encrypt(session('recibos_proveedores'))])}}" id='document_1' target="_blank" onclick="closeTootips();" class="btn btn-info" style="margin-top: 30px;" data-toggle="tooltip" data-placement="bottom" title="Comprobante 1"><i class="fa fa-file-text fa-3x" aria-hidden="true"></i></a>
					<a href="https://www.dualtrucks.com/" id='document_2' target="_blank" onclick="closeTootips();" class="btn btn-success" style="margin-top: 30px;" data-toggle="tooltip" data-placement="bottom" title="Comprobante 2"><i class="fa fa-file-text fa-3x" aria-hidden="true"></i></a>
				</div>
	...
	<div class="card">
		...
		<div class="card-body">
			<div class="1">
				@include('admin.partials.GastosDiversosF')
			</div>
		</div>
	</div>
	...
	function BuscarVIN(Referencia,Formulario){
		...
		if (Formulario == 1) {
			...
			$("#respuesta_referecia_anticipo").html('<i class="fas fa-spinner fa-spin" style="position: initial;color:green;"></i>Buscando Referencia');
