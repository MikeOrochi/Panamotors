                ...
                <div class="col-md-6 content-center-flex p-0">
                    <div>
                        ...
                        <div class="d-flex">
                            ...
                            <div class="content-dato-base">
                                <h6>@if(!empty($proveedor->calle)){{$proveedor->calle}}@else {{"N/A"}}@endif</h6>
                            </div>
                        </div>
                        <div class="d-flex">
                            <div class="content-dato">
                            ...
                            <div class="content-dato-base">
                                <h6>@if(!empty($proveedor->colonia)){{$proveedor->colonia}}@else{{"N/A"}} @endif</h6>
                            </div>
                        </div>
                        <div class="d-flex">
                            <div class="content-dato">
                            ...
                            <div class="content-dato-base">
                                <h6>@if(!empty($proveedor->delmuni)){{$proveedor->delmuni}}@else {{"N/A"}}@endif</h6>
                            </div>
                        </div>
                        <div class="d-flex">
                            <div class="content-dato">
                    ...
                    <div class="content-datos-adicional content-center-flex">
                        <div>
                            <div class="d-flex">
                                ...
                                <div class="content-dato-base">
                                    <h6>@if(!empty($fecha_recibo_encabezado)){{$fecha_recibo_encabezado}}@else{{"N/A"}}@endif</h6>
                                </div>
                            </div>
                            <div class="d-flex">
                                <div class="content-dato">
                                ...
                                <div class="content-dato-base">
                                    <h6>@if(!empty($id_generic_voucher)){{$id_generic_voucher}}@else{{"N/A"}}@endif</h6>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="content-tablas">
            <div class="table-responsive">
                <table class="tabla-1 table">
                    ...
                    <tr>
                        <td>@if(!empty($recibo->concepto)){{$recibo->concepto}}@else{{"N/A"}} @endif</td>
                        <td>@if(!empty($metodo_pago)){{$metodo_pago->nombre}}@else{{"N/A"}}@endif</td>
                        <td>@if(!empty($recibo->tipo_cambio)){{$recibo->tipo_cambio}}@else{{"N/A"}}@endif</td>
                    </tr>
                </table>
            </div>
        </div>
        <div class="content-tablas">
            <div class="table-responsive">
                <table class="tabla-1 table">
                    ...
                    <tr>
                        <td></td>
                        <td>@if(!empty($total_text)){{$total_text}}@else{{"CERO 00/100"}}@endif</td>
                    </tr>
                </table>
            </div>
        </div>
        <div class="dato-user-impresion">
            <p>Recibido por: <span>@if(!empty($nombre_usuario)){{$nombre_usuario}}@else{{"N/A"}}@endif</span></p>
            <p>Fecha impresión: <span>@if(!empty($string_fecha)){{$string_fecha}}@else{{'N/A'}}@endif</span></p>
        </div>
