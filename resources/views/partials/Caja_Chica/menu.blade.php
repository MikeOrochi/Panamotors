		...
		<div class="inner-sidebar mr-3">
			...
			<div class="sidebar-menu-container">
				<ul class="sidebar-menu mb-4">
					...
					<li class="parent">
						<a href="" class="{{route('Caja_Chica.index')}}"><i class="fas fa-home mr-3"></i>
					...
					<li class="parent">
						<a href="" onclick="toggle_menu('auxiliares'); return false" class=""><i class="fas fa-id-card-alt mr-3"> </i>
							<i class=""></i>
							<span class="none">Auxiliares <i class="fa fa-angle-down pull-right align-bottom"></i></span>
						</a>
						<ul class="children" id="auxiliares">
							<li class="child"><a href="{{route('Caja_Chica.auxiliares')}}" class="ml-4"><i class="fas fa-check-square mr-2"></i> Auxiliares</a></li>
						</ul>
					</li>
