						...
						<a href="generar_nueva_contrasenia.php" class="dropdown-item">
							<div class="media">
								...
								<div class="media-body">
									...
									<p>Ver</p>
									<small class="text-success">Tirmpo Restante: <?php echo $tiempo_restante; ?> minutos</small>
								</div>
							</div>
						</a>
						<?php endif ?>
		...
		<div class="inner-sidebar mr-3">
			...
			<div class="sidebar-menu-container">
				<ul class="sidebar-menu mb-4">
					...
					{{-- <li class="parent">
						<a href="" class="{{route('CreditoCobranza.AdminController.index')}}"><i class="fas fa-home mr-3"></i>
					...
					{{-- <li class="parent">
						<a href="" onclick="toggle_menu('auxiliares'); return false" class=""><i class="fas fa-user-tag mr-3"></i>
							<i class=""></i>
							<span class="none">Clientes </span>
						</a>
						<ul class="children" id="auxiliares">
							<li class="child"><a href="{{route('CreditoCobranza.contact.new')}}" class="ml-4"><i class="fas fa-user-plus mr-2"></i> Agregar</a></li>
							<li class="child"><a href="{{route('CreditoCobranza.contact.index')}}" class="ml-4"><i class="fas fa-users mr-2"></i> Cartera</a></li>
						</ul>
					</li> --}}
                    ...
                    <li class="parent">
						<a href="{{route('TallerTracktoController.new')}}" class=""><i class="fa fa-plus mr-3"></i>
							<span class="none">Nuevo ingreso </span>
						</a>
					</li>
                    <li class="parent">
						<a href="{{route('SalidasTallerTrackto.index')}}" class=""><i class="fa fa-file mr-3"></i>
							<span class="none">Gestionar entregas </span>
						</a>
					</li>
                    <li class="parent">
						<a href="{{route('SalidasTallerTrackto.historial')}}" class=""><i class="fa fa-history mr-3"></i>
							<span class="none">Historial </span>
						</a>
					</li>
					<li class="parent">
