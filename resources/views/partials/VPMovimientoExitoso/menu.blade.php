		...
		<div class="inner-sidebar mr-3">
			...
			<div class="sidebar-menu-container">
				<ul class="sidebar-menu mb-4">
					...
					<li class="parent">
						<a href="{{route('VPMovimientoExitoso.index')}}" class=""><i class="fas fa-home mr-3"></i>
					...
					<li class="parent">
                        <a href="" onclick="toggle_menu('auxiliares'); return false" class=""><i class="fas fa-user-tag mr-3"></i>
							<i class=""></i>
							<span class="none">Movimientos</span>
						</a>
						<ul class="children" id="auxiliares">
							<li class="child"><a href="{{route('VPMovimientoExitoso.index')}}" class="ml-4"><i class="fas fa-plus mr-2"></i> Agregar</a></li>
							<li class="child"><a href="{{route('VPMovimientoExitoso.listaVentas')}}" class="ml-4"><i class="fas fa-car mr-2"></i> Ventas</a></li>
						</ul>
					...
					<li class="parent">
						<a href="{{
							\Request::cookie('Sitio') == 'DualTrucks' ? route('admin.profiles') : 'https://www.panamotorscenter.com/Des/CCP/direcionador_perfiles.php'
						}}" class=""><i class="fas fa-exchange-alt mr-3"></i>
					...
					<li class="parent">
						<a href="
						{{
							\Request::cookie('Sitio') == 'DualTrucks' ? route('logout') : route('logout.externo')
						}}" class=""><i class="fas fa-door-open mr-3"></i>
